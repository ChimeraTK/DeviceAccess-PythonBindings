...
namespace ChimeraTK {
  ...
  const std::set<std::string> PyTransferElementBase::specialAssignmentFunctionsToEmulateNumeric{"__iadd__", "__isub__",
      "__imul__", "__itruediv__", "__ifloordiv__", "__imod__", "__ipow__", "__iand__", "__ior__", "__ixor__",
