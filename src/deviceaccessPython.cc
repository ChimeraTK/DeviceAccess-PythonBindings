...
PYBIND11_MODULE(_da_python_bindings, m) {
  ...
  //   m.def(
  //       "testUserTypeTemplateVariantNoVoid",
  //       []([[maybe_unused]] const ChimeraTK::UserTypeTemplateVariantNoVoid<Vector>& vec) {
  //         std::cout << "Test function for UserTypeTemplateVariantNoVoid called" << std::endl;
  //       },
  //       "Test function for UserTypeTemplateVariantNoVoid.", py::arg("value") = "Hello, World!");
  ...
  m.def(
      ...
      "Test function for UserTypeVariantNoVoid.", py::arg("value") = "Hello, World!");
  ...
  //       are " "related and update each other.\n"
  //       "\n"
