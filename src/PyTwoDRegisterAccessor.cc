...
namespace ChimeraTK {
  ...
  size_t PyTwoDRegisterAccessor::getNElements() {
    size_t rv;
    ...
    std::visit(
        [&](auto& acc) {
          ...
          if constexpr(std::is_same<userType, std::string>::value) {
            ...
            auto ary = py::array(py::dtype::of<userType>(), {acc.getNElementsPerChannel()}, {sizeof(userType)},
  ...
  void PyTwoDRegisterAccessor::bind(py::module& m) {
    py::class_<PyTwoDRegisterAccessor, PyTransferElementBase, std::unique_ptr<PyTwoDRegisterAccessor, py::nodelete>>
        arrayacc(m, "ArrayAccessor", py::buffer_protocol());
    arrayacc.def(py::init<>())
        ...
        .def("dataValidity", &PyTwoDRegisterAccessor::dataValidity,
            ...
            "support it")
        .def(
            "getNElements", &PyTwoDRegisterAccessor::getNElements, "Return number of elements/samples in the register.")
        ...
        .def("setAndWrite", &PyTwoDRegisterAccessor::setAndWrite,
            ...
            py::arg("newValue"))
        .def("readAndGet", &PyTwoDRegisterAccessor::readAndGet,
            "Convenience function to read and return an array of UserType.")
        .def("__repr__", &PyTwoDRegisterAccessor::repr)
        .def("__getitem__", &PyTwoDRegisterAccessor::getitem)
        .def("__setitem__", &PyTwoDRegisterAccessor::setitem)
