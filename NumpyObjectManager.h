...
namespace boost { namespace python { namespace converter {
  ...
  template<>
  struct object_manager_traits<mtca4upy::NumpyObject> {
    ...
    static inline python::detail::new_reference adopt(PyObject* obj) {
      return python::detail::new_reference((python::pytype_check((PyTypeObject*)get_pytype(), obj)));
    }

    static inline bool check(PyObject* obj) { return PyObject_IsInstance(obj, (PyObject*)get_pytype()); }
